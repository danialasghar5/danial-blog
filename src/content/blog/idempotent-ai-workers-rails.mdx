...
import IdempotentWorkerFlow from '../../components/diagram/figures/IdempotentWorkerFlow.astro';
...
<nav class="toc" aria-label="Table of contents" style="border:1px solid var(--border); border-radius: var(--radius); background: var(--bg-subtle); padding: var(--s-2) var(--s-3); margin: 0 0 var(--s-4);">
  ...
  <ul style="margin:0; padding-left:1.1rem;">
    <li><a href="#why-an-llm-makes-double-execution-worse">Why an LLM makes double-execution worse</a></li>
    <li><a href="#what-idempotency-means-for-an-llm-worker">What idempotency means for an LLM worker</a></li>
    <li><a href="#the-shipped-gate-status-based-idempotency-on-the-uuid">The shipped gate: status-based idempotency on the UUID</a></li>
    <li><a href="#where-a-status-gate-isnt-enough-the-check-then-act-race">Where a status gate isn't enough: the check-then-act race</a></li>
    <li><a href="#a-subtle-case-the-model-succeeded-the-write-didnt">A subtle case: the model succeeded, the write didn't</a></li>
    <li><a href="#common-idempotency-mistakes">Common idempotency mistakes</a></li>
    <li><a href="#tradeoffs">Tradeoffs</a></li>
    <li><a href="#failure-modes">Failure modes</a></li>
    <li><a href="#testing-and-monitoring-idempotent-workers">Testing and monitoring idempotent workers</a></li>
    <li><a href="#whats-shipped-vs-whats-planned">What's shipped vs. what's planned</a></li>
