...
export const Button = (props) => <button style={{padding:'.5rem 1rem',borderRadius:'8px',border:'1px solid var(--border)',background:'var(--brand)',color:'#fff',cursor:'pointer',font:'inherit'}} {...props} />;
